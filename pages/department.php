                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        echo '
                            ...
                            <td>
                                ...
                                data-bs-target="#editDepartmentModal">Edit</a>
                                <a href="crudDepart.php?delete_id=' . $id . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this department?\');">Delete</a>
                            </td>
                            </tr>';
                        }
                    } else {
