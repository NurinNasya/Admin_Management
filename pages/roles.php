...
<head>
    ...
    <style>
        /* Add these new styles to prevent overlap and improve table layout */
        .main-content {
            margin-top: 20px; /* Adds space below navbar */
        }
        .table-container {
            max-height: calc(100vh - 250px); /* Makes table scrollable */
            overflow-y: auto;
        }
        .compact-table {
        ...
        .compact-table th, 
        .compact-table td {
            padding: 0.5rem 0.75rem; /* More compact cells */
        }
        .compact-table .badge {
            font-size: 0.75rem; /* Smaller status badges */
        }
        /* Compact navigation item styles */
        .compact-nav-item .icon-xs {
            width: 1.25rem;
            height: 1.25rem;
        }
        .compact-nav-item .text-xs {
            font-size: 0.75rem;
        }
        .compact-nav-item .nav-link {
            padding-top: 0.25rem;
            padding-bottom: 0.25rem;
        }
        .compact-nav-item .small {
            font-size: 0.75rem;
        }
        /* Alert styles */
        .alert-success {
...
<body class="g-sidenav-show bg-gray-100">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item compact-nav-item">
                    <a class="nav-link py-1 px-2" href="../pages/tables.html">
                        <div class="icon icon-shape icon-xs border-radius-md text-center me-1 d-flex align-items-center justify-content-center">
                            <i class="ni ni-calendar-grid-58 text-dark text-xs opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1 small">Tables</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="collapse" href="#settingsMenu" role="button" aria-expanded="true" aria-controls="settingsMenu">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Role Management</li>
                    </ol>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                                        <form action="crudrole.php" method="POST" class="d-inline">
                                            <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token']; ?>">
                                            <button type="submit" name="reset_ids" class="btn btn-warning btn-sm mb-0 me-2"
                                                onclick="return confirm('Are you sure you want to reset ID counter? This won\'t affect existing records.')">
                                                Reset ID Counter
                                            </button>
                                        </form>
                                    <?php endif; ?>
                        ...
                        <?php if (isset($_SESSION['message'])): ?>
                            <div class="alert alert-success alert-dismissible fade show mx-4 alert-auto-dismiss" role="alert">
                        ...
                        <?php if (isset($_SESSION['error'])): ?>
                            <div class="alert alert-danger alert-dismissible fade show mx-4 alert-auto-dismiss" role="alert">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-3 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm"><?= htmlspecialchars($row['id']); ?></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-sm <?= $row['status'] ? 'bg-gradient-success' : 'bg-gradient-secondary' ?>">
                        ...
                        <form action="crudrole.php" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="name" class="form-control-label required-field">Role Name</label>
                                    <input class="form-control" type="text" id="name" name="name" required maxlength="100">
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="crudrole.php" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="edit_name" class="form-control-label required-field">Role Name</label>
                                    <input class="form-control" type="text" id="edit_name" name="name" required maxlength="100">
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Hide alerts after form submission
